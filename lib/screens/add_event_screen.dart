...
import './event_success_screen.dart';
...
class _AddEventScreenState extends State<AddEventScreen> {
  ...
  bool _useParentCategories = false;
  bool _useParentAddress = false;
  bool _allowRegistrations = false;

  Future<void> _submitProject() async {
    Navigator.of(context).pushReplacement(
      MaterialPageRoute(
        builder: (ctx) => EventSuccessScreen(),
      ),
    );
  }
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              CheckboxListTile(
                title: Text('Enable Registrations'),
                value: _allowRegistrations,
                onChanged: (value) {
                  setState(() {
                    _allowRegistrations = value;
                  });
                },
              ),
              SizedBox(
              ...
              CheckboxListTile(
                title: Text('Use Parent Project Categories'),
                value: _useParentCategories,
                onChanged: (value) {
                  setState(() {
                    _useParentCategories = value;
                  });
                },
              ),
              SizedBox(
              ...
              CheckboxListTile(
                title: Text('Use Parent Project Address'),
                value: _useParentAddress,
                onChanged: (value) {
                  setState(() {
                    _useParentAddress = value;
                  });
                },
              ),
              SizedBox(
              ...
              CheckboxListTile(
                title: Text(
                    'Okay for Pro service providers and category sponsors to contact me about my event'),
